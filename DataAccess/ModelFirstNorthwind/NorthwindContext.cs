...
public partial class NorthwindContext : DbContext
{
    ...
    {
     // Buraya düşüyor , buradan DB bağlanamıyor sistem , debug : Foreach statment cannot operate on variable of type 'Product' because 'Product' does not contain a public instance or extansion definitaion fopr 
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomersWork>(entity =>
        {
            entity.HasKey(e => e.CustomerId);

            entity.ToTable("CustomersWork");
